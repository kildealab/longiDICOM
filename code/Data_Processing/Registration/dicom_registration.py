...
CT_CBCT_save_path = '/data/kayla/HNC_images/CBCT_method_dec23/CT_CBCT/'
CBCT_CBCT_save_path = '/data/kayla/HNC_images/CBCT_method_dec23/CBCT_CBCT/'
...
def register_CT_CBCT(patient_path = patient_path):
        print(patient_path)
        global image_dict
        image_dict.clear()
        replan = False
